public class Mountain {
    public static void main(String[] args) {
        // Example usage
        int[] mountainArray = {1, 2, 3, 4, 5, 6, 7, 8, 9, 3, 1};
    ...
    static int peakIndexInMountainArray(int[] arr) {
        ...
        // and if we are saying that only one item is remaining, hence because of the above line that is the best possible answer
